...
#define g_logger_debug(format, ...) printf("[Debug] " format "\n", ##__VA_ARGS__)
#define g_logger_info(format, ...) printf("[Info] " format "\n", ##__VA_ARGS__)
#define g_logger_warning(format, ...) printf("[Warning] " format "\n", ##__VA_ARGS__)
#define g_logger_error(format, ...) printf("[Error] " format "\n", ##__VA_ARGS__)
