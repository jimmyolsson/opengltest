...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("resources\\6.multiple_lights.vs", "resources\\6.multiple_lights.fs");
    Shader lightCubeShader("resources\\6.light_cube.vs", "resources\\6.light_cube.fs");
